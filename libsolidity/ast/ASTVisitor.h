...
public:
	...
	virtual bool visit(FormalDocumentation& _node) { return visitNode(_node); }
	...
	virtual void endVisit(FormalDocumentation& _node) { endVisitNode(_node); }
...
public:
	...
	virtual bool visit(FormalDocumentation const& _node) { return visitNode(_node); }
	...
	virtual void endVisit(FormalDocumentation const& _node) { endVisitNode(_node); }
