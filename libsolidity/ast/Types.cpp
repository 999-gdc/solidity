...
ASTPointer<FormalDocumentation> FunctionType::documentation() const
{
	auto function = dynamic_cast<FormallyDocumented const*>(m_declaration);
	if (function)
		return function->documentation();

	return ASTPointer<FormalDocumentation>();
}
